...
void iEnvLoad(iEnv* env, const void* data, U32, S32 dataType) NONMATCH("https://decomp.me/scratch/dpZ2q")
{
    ...
    if (jsp->idtag[0] == 'J' &&
        ...
        if (dataType == 0) {
            ...
            sPipeCamera = iCameraCreate(FB_XRES, FB_YRES, 0);
            ...
            // BUG: sPipeWorld not destroyed, mem leak?
            sPipeWorld = NULL;
            sPipeCamera = NULL;
        }
    } else {
